...
vidios.innerHTML = content1.join('');
...
const proletWord = document.querySelector('.proletWord');
let content4 = prolitSlovo.map(block => `
        <div class='vidik'>
          <h4>${block.name}</h4>
          <br>
          <iframe width="500" height="380" src="https://www.youtube.com/embed/${block.source}" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
proletWord.innerHTML = content4.join('');

const citat = document.querySelector('.citat');
let content5 = cytaty.map(block => `
        <div class='vidik'>
          <h4>${block.name}</h4>
          <br>
          <iframe width="500" height="380" src="https://www.youtube.com/embed/${block.source}" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
citat.innerHTML = content5.join('');

const theory = document.querySelector('.theory');
let content6 = teorija.map(block => `
        <div class='vidik'>
          <h4>${block.name}</h4>
          <br>
          <iframe width="500" height="380" src="https://www.youtube.com/embed/${block.source}" frameborder="0" allow="accelerometer; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
