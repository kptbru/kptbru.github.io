let blocks = [
    {
      name: '«Независимость» современной Украины',
      photo: 'images/independentUkraine',
      discription:'Здравствуйте, товарищи! Представляем небольшое эссе о "независимой" Украине от нашей редакции.',
      source:'independentUkraine.html',
    },
    {
      name: 'Декрет о мире',
